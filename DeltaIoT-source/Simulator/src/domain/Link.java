...
public class Link {
	...
	private int sfTimeNumber = 11; //corresponds to some time to send, see settings
	...
	public double getSRN(RunInfo runInfo) { //TODO Perhaps better name 'calculateSNR'?
		...
		// Total snr
		double totalSnr = snr - interference; // interference makes snr worse
